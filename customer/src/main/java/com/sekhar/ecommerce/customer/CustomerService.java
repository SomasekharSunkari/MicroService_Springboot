...
public class CustomerService {
    ...
    public CustomerResponse findById(String customerId) {
        ...
        return  repository.findById(customerId).map(mapper::toCustomerResponse).orElseThrow(()-> new CustomerNotFoundException(String.format("Customer not found with id %s", customerId)));
    }
